          ...
          <div className="flex flex-wrap justify-between text-xs font-medium">
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-2">
              <div className="flex items-center gap-2">
                ...
                <span className="dark:text-gray-200">{teacher.email || "-"}</span>
              </div>
              <div className="flex items-center gap-2">
                <Phone width={14} height={14} className="dark:text-white"/>
                <span className="dark:text-gray-200">{teacher.phone || "-"}</span>
              </div>
            </div>
          </div>
          </div>
            <div className="flex-1 grid grid-cols-2 gap-4 w-full">
              <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow flex gap-4 items-center">
                ...
                <div className="flex flex-col">
                  <h1 className="text-2xl font-bold dark:text-white">90%</h1>
                  <span className="text-sm text-gray-500 dark:text-gray-400 font-medium">Attendance</span>
                </div>
              </div>
              <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow flex gap-4 items-center">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400 font-medium">Branches</span>
                </div>
              </div>
              <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow flex gap-4 items-center">
                <div className="p-3 bg-blue-50 dark:bg-slate-700 rounded-full">
              ...
              <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow flex gap-4 items-center">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400 font-medium">Classes</span>
                </div>
              </div>
            </div>
          </div>
